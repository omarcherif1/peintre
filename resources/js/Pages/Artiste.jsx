...
export default function Artiste({ images = [] }) {
    ...
    const DEMARCHE_CARDS = [
        { tag: t('artiste','card0tag'), title: t('artiste','card0title'), text: t('artiste','card0text') },
        { tag: t('artiste','card1tag'), title: t('artiste','card1title'), text: t('artiste','card1text') },
        { tag: t('artiste','card2tag'), title: t('artiste','card2title'), text: t('artiste','card2text') },
    ];
        ...
        <PublicLayout>
            ...
            >
                <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop h-14 flex items-center gap-8">
                    {[
                        { id: 'biographie', label: t('artiste','subnavBio') },
                        { id: 'demarche',   label: t('artiste','subnavDemarche') },
                    ].map(({ id, label }) => (
                        <button
                            key={id}
                ...
                <div className="max-w-container-max mx-auto">
                    <div className="section-child grid lg:grid-cols-12 gap-gutter items-start">
                        ...
                        <div className="lg:col-span-5">
                            <div className="aspect-[4/4] bg-surface border border-primary/30 custom-glow overflow-hidden transition-all duration-700">
                                <img
                        ...
                        <div className="lg:col-span-7 lg:pl-6">
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-10 pb-10 border-b border-on-surface/10">
                                {[
                                    { value: 'Tunis', label: t('artiste','statLabel1') },
                                    { value: '25+',   label: t('artiste','statLabel2') },
                                    { value: '3',     label: t('artiste','statLabel3') },
                                ].map((d) => (
                                    <div key={d.label}>
                            ...
                            <div className="flex flex-wrap gap-6 mb-8">
                                {[
                                    { label: t('artiste','profLabel'), value: t('artiste','profValue') },
                                    { label: t('artiste','lieuLabel'), value: t('artiste','lieuValue') },
                                ].map(({ label, value }) => (
                                    <div key={label}>
            ...
            >
                <div className="max-w-container-max mx-auto">
                    ...
                    <div className="section-child max-w-3xl mx-auto text-center mb-16 py-14 border-y border-on-surface/10">
                        <svg className="mx-auto mb-6" width="38" height="30" viewBox="0 0 44 36" fill="none" aria-hidden="true">
                            <path d="M0 36V22C0 13.556 3.556 6.444 10.667 0.889L14.222 4.444C10.074 8.148 8 12.593 8 17.778H16V36H0ZM24.889 36V22C24.889 13.556 28.444 6.444 35.556 0.889L39.111 4.444C34.963 8.148 32.889 12.593 32.889 17.778H40.889V36H24.889Z" fill="#6B1515" fillOpacity="0.9" />
                        </svg>
                    ...
                    {images.length > 0 && (
                        <div className="section-child grid grid-cols-2 md:grid-cols-4 gap-4">
                            {images.map((img) => (
                                ...
                                >
                                    <img src={img.image_url} alt={img.nom} className="w-full h-full object-cover" />
