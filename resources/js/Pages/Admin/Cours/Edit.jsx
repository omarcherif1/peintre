...
export default function Edit({ cours }) {
    const { data, setData, post, errors, processing } = useForm({
        ...
        jour:             cours.jour ?? '',
        heure_debut:      toInputTime(cours.heure_debut),
        heure_fin:        toInputTime(cours.heure_fin),
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.cours.update', cours.id));
    };
